...
public class CourseUpdate2 extends JDialog {
	...
	public static void main(String[] args) {
		try {
			CourseUpdate2 dialog = new CourseUpdate2();
	...
	public CourseUpdate2() {
		...
		String[] couid=mySQLQueries.getIDForChoice1("r");
		for(int i=0;i<couid.length;i++)
		{
//			System.out.print(couid[i]);
...
//			        else if(msql.getCouseID(cbocoursescid.getSelectedIndex()))
//			        {
//			            JOptionPane.showMessageDialog(null, "Please enter valid Room No.");
//			            txtroom.requestFocus();
//			            txtroom.selectAll();
//			        }
			        	 ...
			        	 String st[] = new String[7];
					        ...
					        { boolean f=false;
					        	//System.out.print(cbocoursescid.getSelectedItem());
								for(int i=0;i<couid.length;i++)
								{
									//System.out.print(couid[i]);
									if(cbocoursescid.getSelectedItem()==couid[i])
									{
										f=true;
									}
								}
								System.out.print(f);
									if(f)
									{
										 JOptionPane.showMessageDialog(null, "Have been regist");	
									}
									else
									{
